...
public class HomeService : IHomeService
{
  ...
  private readonly SportCourtManagerment.Services.Interfaces.IPromotionService    _promotionService;

  public HomeService(
    ApplicationDbContext db,
    ICourtService        courtService,
    SportCourtManagerment.Services.Interfaces.IPromotionService    promotionService)
  {
    _db               = db;
  ...
  public async Task<HomeDataDto> GetHomeDataAsync()
  {
    ...
    var courtTypes = await _db.CourtTypes
      ...
      .Select(ct => new SportCourtManagerment.DTOs.CourtTypes.CourtTypeDto
      {
